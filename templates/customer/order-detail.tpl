...
{block name='page_content'}
    ...
    {block name='addresses'}
        <div class="addresses history__addresses">
            {if $order.addresses.delivery}
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <article id="delivery-address" class="box">
                        <h4>{l s='Delivery address %alias%' d='Shop.Theme.Checkout' sprintf=['%alias%' => $order.addresses.delivery.alias]}
                        </h4>
    ...
    {block name='order_carriers'}
        {if $order.shipping}
            <div class="box">
                <table class="table table-striped table-bordered hidden-sm-down table-bottom">
                    <thead class="thead-default">
                        <tr>
                            <th>{l s='Date' d='Shop.Theme.Global'}</th>
